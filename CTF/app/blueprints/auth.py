    ...
    if form.validate_on_submit():
        ...
        if user:
            try:
                ...
                flash('A password reset link has been sent to your email. Check your inbox and follow the link to reset your password.', 'success')
                return redirect(url_for('auth.login'))
...
def reset_password(token):
    ...
    if not email:
        flash('The reset link is invalid or has expired. Please request a new password reset.', 'danger')
